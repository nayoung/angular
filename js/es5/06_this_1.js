...
//console.log('someValue :' + someValue); // error
function Person() {
  this.someValue = 2;
  var someValue2 = 3;
  
  // return 1;  // 라고 있어도 new선언은 return json값을 받기 위함이기에 리턴이 없는걸로 처리함
}

// 함수를 호출할때 this는 전역변수
// Person 함수를 호출하는 순간에 someValue가 전역객체에 변수로 포함된다.
//Person(); //실행결과는? 그 이유는?
//console.log('someValue2 : ' + someValue2);  // error
//console.log('someValue : ' +  someValue); // 2
...
console.log(person.someValue); // 2
